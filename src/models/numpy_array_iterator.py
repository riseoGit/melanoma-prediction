...
from .iterator import BalanceIterator
from .balanced_generator import _balanced_batch_apply

class BalanceNumpyArrayIterator(BalanceIterator):
    def __init__(self,
                 x,
                 y,
        ...
        #phtcong
        #tstep = self._get_steps_per_epoch(self.y, batch_size)
        tstep, batch_size_one, batch_size_zero = _balanced_batch_apply(self.y, batch_size = batch_size, balanced_type = self.balanced_type)
        tn = tstep * batch_size
        print("BalanceNumpyArrayIterator->n=", tn)
        super(BalanceNumpyArrayIterator, self).__init__(tn,
                                                 batch_size,
                                                 shuffle,
                                                 seed,
                                                 y = self.y,
