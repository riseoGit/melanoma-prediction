...
from .balanced_iterator import BalancedIterator
from .balanced_generator import _balanced_batch_apply

class BalancedNumpyArrayIterator(BalancedIterator):
    def __init__(self,
                 x,
                 y,
        ...
        #phtcong
        step, batch_size_one, batch_size_zero = _balanced_batch_apply(self.y, batch_size = batch_size, balanced_type = self.balanced_type)
        tn = step * batch_size
        super(BalancedNumpyArrayIterator, self).__init__(tn,
                                                 batch_size,
                                                 shuffle,
                                                 seed,
                                                 y = self.y,
